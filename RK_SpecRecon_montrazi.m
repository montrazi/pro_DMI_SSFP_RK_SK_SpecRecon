function outParams=RK_SpecRecon_montrazi(imDataParams,algoParams,forceB0,alpha,FirstPointReg)
...
if Nz>1
%%%% Regularization for kinetic dimension %%%%
r=-diag(ones(Nspec*Nz,1))+diag(ones(1,Nspec*Nz-Nspec),Nspec);
r=r(1:end-Nspec,:);
for p=1:length(FirstPointReg)
    r(p,:)=r(p,:)*FirstPointReg(p);
end
R=(r'*r);
R=alpha*R;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
